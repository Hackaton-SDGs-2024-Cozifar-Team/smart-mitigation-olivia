...
@section('content')
    ...
    <p class="text-gray-600 text-sm mb-5">Hallo selamat datang BPBD👋</p>
    <div class="grid grid-cols-3 gap-5">
        ...
        <div class="bg-blue1 p-4 rounded-lg shadow-md flex-1">
            <div class="flex items-center justify-between">
                <i class="ri-notification-2-line text-5xl text-blue4"></i>
                <h1 class="text-5xl font-bold text-blue4">{{ $laporan_bencana->count() }}</h1>
            </div>
            <p class="font-bold text-blue4">Laporan Bencana</p>
        </div>
        <div class="bg-blue1 p-4 rounded-lg shadow-md flex-1">
            <div class="flex items-center justify-between">
                <i class="ri-money-dollar-circle-line text-5xl text-blue4"></i>
                <h1 class="text-4xl font-bold text-blue4">{{ $donasi_barang->sum('jenis_donasi') }}</h1>
            </div>
    ...
    <div class="w-full h-auto border-2 border-blue-300 border-dashed rounded-lg mt-10">
        <div class="p-4 rounded-lg shadow-md transition">
            <h1 class="text-xl font-bold text-blue1 mb-2">Grafik Korban Bencana</h1>
            <canvas id="lineChart" width="400" height="150"></canvas>
        </div>
    </div>

    <div class="mt-10 flex space-x-4 shadow-md">
        <div class="w-8/12 bg-bltext-blue-800 border-dashed border-2 border-blue-300 p-5 rounded-lg shadow-lg">
                    ...
                    @foreach ($penggunaan_donasi as $penggunaan)
                        <tr class="hover:bg-blue-50">
                            ...
                            <td class="py-3 px-4 border-b border-blue-100"><a
                                    href="{{ route('admin.penggunaan-donasi') }}">{{ $penggunaan->nama_kebutuhan }}
                            </td>
                        ...
                        <li class="flex items-center">
                            ...
                            <div class="flex flex-col w-full">
                                <div class="flex items-center">
                                    {{-- <a href="#"><span class="font-bold">{{ $donasi->user->nama }}</span></a> --}}
                                </div>
