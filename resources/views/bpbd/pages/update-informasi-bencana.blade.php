...
@section('content')
    <div class="bg-white shadow-lg rounded-lg p-6">
        <div class="container mx-auto px-4 py-6">
            <form action="{{ route('bpbd.informasi-bencana.update', $informasi_bencana->id_informasi_bencana) }}"
                method="POST">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="mb-5">
                        ...
                        <select id="countries" name="id_laporan_bencana"
                            ...
                            <option disabled><--- Pilih Bencana Alam ---></option>
                            @foreach ($laporan_bencana as $data)
                                <option value="{{ $data->id_laporan_bencana }}"
                                    {{ $data->id_laporan_bencana == $informasi_bencana->id_laporan_bencana ? 'selected' : '' }}>
                                    {{ $data->nama_bencana }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="number" id="korban_terluka" name="korban_terluka"
                            value="{{ $informasi_bencana->korban_terluka }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            required />
                    </div>
                    <div class="mb-5">
                        ...
                        <input type="number" id="korban_meninggal" name="korban_meninggal"
                            value="{{ $informasi_bencana->korban_meninggal }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            required />
                    </div>
                    <div class="mb-5">
                        ...
                        <input type="number" id="korban_hilang" name="korban_hilang"
                            value="{{ $informasi_bencana->korban_hilang }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            required />
                    </div>
                    <div class="mb-5">
                        ...
                        <input type="number" id="korban_menungsi" name="korban_mengungsi"
                            value="{{ $informasi_bencana->korban_mengungsi }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            required />
                    </div>
                    <div class="mb-5">
                        ...
                        <select id="dampak_kerusakan" name="dampak_kerusakan"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option disabled><--- Dampak Kerusakan ---></option>
                            <option {{ $informasi_bencana->dampak_kerusakan == 'rendah' ? 'selected' : '' }}>rendah</option>
                            <option {{ $informasi_bencana->dampak_kerusakan == 'redang' ? 'selected' : '' }}>redang</option>
                            <option {{ $informasi_bencana->dampak_kerusakan == 'tinggi' ? 'selected' : '' }}>tinggi
                            </option>
                        </select>
                    </div>
                </div>
