    ...
    <div class="bg-white shadow-lg rounded-lg p-6">
        <div class="container mx-auto px-4 py-6">
                        ...
                        @foreach ($laporan_bencana as $bencana)
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700 transition duration-300">
                                ...
                                <td class="py-2 px-4 flex gap-2 items-center">
                                    <form
                                        action="{{ route('bpbd.laporan-bencana.diterima', $bencana->id_laporan_bencana) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <button type="submit"
                                    ...
                                    <form action="{{ route('bpbd.laporan-bencana.ditolak', $bencana->id_laporan_bencana) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <button type="submit"
                                            class="text-red-700 px-4 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 rounded-lg p-2">
                                            <i class="ri-close-fill"></i>
                                        </button>
                                    </form>
                                    <button type="button"
                                        data-modal-target="modal-detail-{{ $bencana->id_laporan_bencana }}"
                                        data-modal-toggle="modal-detail-{{ $bencana->id_laporan_bencana }}"
            ...
            @foreach ($laporan_bencana as $laporan)
                <div id="modal-detail-{{ $laporan->id_laporan_bencana }}" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <div
                                ...
                                <button type="button"
                                    ...
                                    data-modal-hide="modal-detail-{{ $laporan->id_laporan_bencana }}">
                            ...
                            <div class="p-4 md:p-5">
                                ...
                                <div class="mb-3">
                                    <span class="block text-md font-medium text-gray-900 dark:text-gray-200">Tanggal
                                        Kejadian:</span>
                                    <p class="text-sm text-gray-700 dark:text-gray-400">{{ $laporan->tanggal_kejadian }}
                                    </p>
                                </div>
                                <div class="mb-3">
                                    <span class="block text-md font-medium text-gray-900 dark:text-gray-200">Nama
                                ...
                                <div class="mb-3">
                                    <span class="block text-md font-medium text-gray-900 dark:text-gray-200">Desa
                                        Kejadian:</span>
                                    <p class="text-sm text-gray-700 dark:text-gray-400">{{ $laporan->desa->nama_desa }}</p>
                                </div>
                                <div class="mb-3">
                                    <span class="block text-md font-medium text-gray-900 dark:text-gray-200">Foto
                                        Bencana:</span>
                                    <img src="{{ asset("uploads/bencana/$laporan->foto_bencana") }}" alt="Foto Bencana"
